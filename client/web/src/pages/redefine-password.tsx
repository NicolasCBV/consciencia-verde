              ...
              Redefinição de senha 
						...
						<div className="flex mt-4 w-full justify-between mini:grid mini:gap-2 mini:place-content-center">
							...
							<Button
								...
								href="/login"
								type="button"
								className="not-prose grid text-slate-900 place-self-center h-[1.2rem] place-content-center rounded-md bg-transparent hover:bg-slate-200/20 hover:text-slate-700 duration-200"
							/> 
						</div>
					</form>
				</main>
